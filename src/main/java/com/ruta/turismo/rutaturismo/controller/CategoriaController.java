...
import com.ruta.turismo.rutaturismo.session.CategoriaFacade;
...
public class CategoriaController implements Serializable {
    ...
    @EJB
    private com.ruta.turismo.rutaturismo.session.CategoriaFacade ejbFacade;
        ...
        if (selected != null) {
            ...
            try {
                if (persistAction == PersistAction.CREATE) {
                     ...
                     selected.setIdCategoria(incremento);
